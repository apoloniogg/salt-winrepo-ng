...
vscode:
  '{{version}}':
    ...
    installer: 'https://az764295.vo.msecnd.net/stable/c7d83e57cd18f18026a8162d042843bda1bcf21f/VSCodeUserSetup-x64-{{ version }}.exe'
    {% else %}
    installer: 'https://az764295.vo.msecnd.net/stable/c7d83e57cd18f18026a8162d042843bda1bcf21f/VSCodeUserSetup-ia32-{{ version }}.exe'
    {% endif %}
